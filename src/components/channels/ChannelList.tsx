    ...
    return (
      <div className="col-span-full py-24 text-center bg-white/5 rounded-[40px] border-2 border-dashed border-white/5 flex flex-col items-center gap-6 animate-in fade-in duration-700">
         ...
         <div className="space-y-1">
            <p className="text-white/80 font-black uppercase tracking-[0.2em] text-sm italic font-headline">Nenhum Canal Detectado</p>
    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
        {channels.map((channel) => {
          ...
          const isConnected = channel.config?.status === 'connected';
                ...
                <div className="flex justify-between items-start mb-8">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                         ...
                         {channel.config?.bot_username && (
                            <span className="text-[9px] font-bold text-kinetic-orange uppercase tracking-tighter opacity-60">
                              @{channel.config.bot_username}
                            </span>
                         )}
                      </div>
                  ...
                  <div className="flex flex-col items-end gap-3">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-[220px] bg-anthracite-surface border-white/5 shadow-skeuo-elevated">
